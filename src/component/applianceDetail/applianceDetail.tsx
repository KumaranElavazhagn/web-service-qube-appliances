    ...
    return (
        <div>
            <div className="m-4 ps-2">
                <span className="data-txt cursor-pointer" onClick={() => { navigate("/") }}>Devices</span>
                <img className="mx-2" src="../Images/bread-crumb.svg" alt="filter icon" />
                <span>{applianceId}</span>
            </div>
